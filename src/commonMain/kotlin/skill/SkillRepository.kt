...
class SkillRepository {
    ...
    companion object {
        private val acrobatics = Skill(
            ...
            repository.getAbility("Dexterity")!!,
            emptyList(),
            emptyList()
        )
        ...
        private val arcana = Skill(
            ...
            repository.getAbility("Intelligence")!!,
            emptyList(),
            emptyList()
        )
        ...
        private val athletics = Skill(
            ...
            repository.getAbility("Strength")!!,
            emptyList(),
            emptyList()
        )
        ...
        private val deception = Skill(
            ...
            "You can trick and mislead others using disguises, lies, and other forms " +
                    "of subterfuge.",
            repository.getAbility("Charisma")!!,
            emptyList(),
            emptyList()
        )
